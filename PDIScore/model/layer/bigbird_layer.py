...
class BigBirdBlockSparseAttention(nn.Module):
    ...
    def bigbird_block_sparse_attention(
        ...
        first_context_layer = self.torch_bmm_nd(first_attn_weights, value_layer, ndim=4)#;print('z', first_attn_weights.size(), value_layer.size(), first_attn_weights.size())
        ...
        context_layer = torch.cat(
            ...
            dim=2,
        ) #;print('z',first_context_layer.size() )
...
class SingleBigBirdLayer(BigBirdModel):
    ...
    def __init__(self, config):
        ...
        assert config.attention_type == "block_sparse", "Singledim_hidden is configured to have sparse attention"
        config.layers = 1
